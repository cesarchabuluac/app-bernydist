...
<head>
    ...
    <title>Berny Distribuidora</title>
    <!-- <link href=/css/app.e2713bb0.css rel=preload as=style>
    <link href=/js/app.aa7c3280.js rel=preload as=script>
    <link href=/js/chunk-vendors.ecd76ec1.js rel=preload as=script>
...
<body><noscript><strong>We're sorry but frontend doesn't work properly without JavaScript enabled. Please enable it to continue.</strong></noscript>
    <div id=app></div>
    <!-- <script src=/js/chunk-vendors.ecd76ec1.js></script> -->
    <!-- <script src=/js/app.aa7c3280.js></script> -->
</body>
